...
export default {
  ...
  methods: {
    ...
    showDataPerson() {
      axios.post('/evaluatebackend/api/showDataPerson', {
    ...
    async savedata1() {
      await axios.post('/evaluatebackend/api/savedatadate', {
        d_date: this.d_date,
  ...
  methods: {
    ...
    selectDataH(year, fac) {  
      axios.post('/evaluatebackend/api/selectDataPersonH', {
        year: year.value,
        fac: fac,
      }).then(res => {     
    ...
    async saveData() {
      await axios.post('/evaluatebackend/api/saveDataPerson', {
        staff_id: this.staffid_Main,
        fac_id: this.facid_Main,
    ...
    async editData(data) {   
      await axios.post('/evaluatebackend/api/edtDataPerson', {
        p_id: data.p_id
      }).then(res => { 
        this.DialogAdd = true; 
    ...
    async delData(data) {  
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios.post('/evaluatebackend/api/delDataPerson', {
            p_id: data.p_id
          }).then(res => { 
            this.showDataPerson();
            this.showDataP01();
