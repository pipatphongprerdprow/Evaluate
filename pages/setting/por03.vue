...
/*============= ความรู้/ทักษะ/สมรรถนะ ที่ต้องการพัฒนา =============*/ 
        ...
        methods: { 
            ...
            // ดึงข้อมูลเข้าตาราง
            async showDataP03(){
                await axios.post('/evaluatebackend/api/showDataP03New',{
...
/*============= รายงานผลการปฏิบัติราชการตามตัวชี้วัด/ เกณฑ์การประเมิน =============*/
            ...
            OpenDialogAdd(item){ 
                ...
                axios.post('/evaluatebackend/api/p03indData',{
                    p01_id: item.p01_id,
                }).then(res => {
            ...
            saveDataListP03() {   
                if(this.products_list_p03.length == 0){
                    ...
                    axios.post('/evaluatebackend/api/saveListP03', {
...
/*============= หลักฐานที่แสดงถึงผลการปฏิบัติราชการตามเกณฑ์การประเมิน(หลักฐานเชิงประจักษ์) =============*/
                ...
                try {
                    if (this.radioValue === 'doc') {
                        if (!this.doc_no) {
                            ...
                            instance_x.post('/evaluatebackend/api/saveDocP03', formData)
                                .then(res => {
                                    this.showDataP03();
                                    this.Data_Doc();
            ...
            Data_Doc(){
                axios.post('/evaluatebackend/api/sheachDataDoc', {
             ...
             // หลักฐานที่แสดงถึงผลการปฏิบัติราชการตามเกณฑ์การประเมิน(หลักฐานเชิงประจักษ์)
            delDataDocX(data){  
                axios.post('/evaluatebackend/api/deleteDocP03', {
                    doc_id: data.doc_id, 
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post('/evaluatebackend/api/delDocP03', {
                        p01_id: data.p01_id
                    }).then(res => { 
                        this.showDataP03();
                        this.Data_Doc();
...
/*============= ค่าคะแนนที่ได้ =============*/
            OpenDialogScore(item){ 
                ...
                this.score_p03 = null; 
                axios.post('/evaluatebackend/api/p03ScoreData',{
                    p01_id: item.p01_id,
                }).then(res => {
                    // console.log(res.data); 
                    if(res.data.length > 0){
            ...
            saveDataScoreP03() {    
                if(this.score_p03.length == 0){
                    ...
                    axios.post('/evaluatebackend/api/saveScoreP03', {
            ...
            axios.post('/evaluatebackend/api/showdataposp02', { 
            ...
            showdataPo(){  
                ...
                axios.post('/evaluatebackend/api/showDataPo',{
                    staff_id: this.staffid_Main,
            ...
            showPostype(postypename,postypenameid){
                ...
                axios.post('/evaluatebackend/api/showdatapostypename', {
                    postypename: postypetext,
...
/*============= ความรู้/ทักษะ/สมรรถนะ ที่ต้องการพัฒนา =============*/ 
            ...
            AddDatap04(){ 
                axios.post('/evaluatebackend/api/saveEvaTab03xx',{
                    staff_id: this.staffid_Main,
                    fac_id: this.facid_Main,
                    year_id: this.dataPor.d_date,
                    record: this.dataPor.evalua,
            ...
            DeleteRegislick(item) { 
                ...
                axios.post('/evaluatebackend/api/delEvaTab03xx',{
                    id: item
                }).then(res => {  
                    // console.log(res);
            ...
            async saveAssess() {
                try {
                    const response = await axios.post('/evaluatebackend/api/savedataAssess', { 
                        p_staffid: this.staffid_Main,
                        fac_id: this.facid_Main,
                        p_year: this.dataPor.d_date,
                        evalua: this.dataPor.evalua, 
            ...
            showAssess( ) {
                axios .post('/evaluatebackend/api/showdataAssess', { 
                    staff_id:this.staffid_Main,
                    fac_id: this.facid_Main,
