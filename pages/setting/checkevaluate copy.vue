                ...
                <table class="table">
                    ...
                    <tbody>   
                        <tr v-for="(Item, index) in products" :key="index">
                            <td style="padding-left: 5px;width: 4%;text-align: left;">
                            ...
                            <td style="padding-left: 5px;width: 40%;"><b>{{ Item.posnameth }}</b></td>
                                                ...
                                                <table id="ratingTable">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(row3, index) in otherCompetencies" :key="index">
                                                            <td style="text-align: left;">{{ row3.activity }}</td> 
                                                            <td>
                                                                <b v-if="!row3.indicator3" style="color: red;">
                                                                    {{ posnameth == 'ผู้บริหาร' ? '0' : '-' }}
                                                                </b>
                                                                <span v-else>{{ row3.indicator3 }}</span>
                                                            </td>
                                                            <td>  
                                                                <b v-if="!row3.datatable3" style="color: red;">
                                                                    {{ posnameth == 'ผู้บริหาร' ? '0' : '-' }}
                                                                </b> 
                                                                <b v-else style="color: blue;">{{ row3.datatable3 }}</b> 
                                                            </td>
                                                            <td>  
                                                                <b v-if="!row3.selfAssessment3" style="color: red;">
                                                                    {{ posnameth == 'ผู้บริหาร' ? '0' : '-' }}
                                                                </b> 
                                                                <b v-else>{{ row3.selfAssessment3 }}</b> 
                                                            </td>
                                                        </tr> 
    ...
    methods: { 
        ...
        openDataEvalu(data){  
            ...
            let xr = levelMapping[postypetext] || 0;
                ...
                // this.showPostype(this.currentstaff[0].postypenameth,this.postypenameid);  แก้วันที่ 20 /03/ 67
                this.showPostype(this.currentstaff[0].postypenameth,data.posnameid); 
        ...
        //     });
        // },
        showdataPoText(staff_id, facid_Main, d_date, evalua) {  
        ...
        // console.log("postypenameth:", this.postypenameth);
            ...
            axios.post('http://127.0.0.1:8000/api/showDataPo', {
                ...
                if (res.data.length > 0) {
                    const data = res.data[0];
                    this.coreCompetencies = this.coreCompetencies; 
        ...
        async showPostype(postypename,postypenameid) {
            ...
            this.postypenameidXX = postypenameid;
