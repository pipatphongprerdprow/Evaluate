...
export default {
    ...
    methods: {  
        ...
        showDataPerson(){  
            ...
            axios.post('/evaluatebackend/api/showDataPersonX',{
        ...
        async editDatax(data){    
          await axios.post('/evaluatebackend/api/edtDataPersonx',{
              p01_id: data.p01_id
          }).then(res => { 
                // console.log(data);   
                this.DialogAdd = true; 
        ...
        // ดึงข้อมูลภาระงาน
        selectDataHEdt(he){  
            axios.post('/evaluatebackend/api/selectDataPersonH').then(res => {     
                // console.log(res.data); 
        ...
        async delDatax(data) {        
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post('/evaluatebackend/api/delDataPersonx', {
                        p01_id: data.p01_id
                    }).then(res => { 
                        this.showDataPerson(); 
                        Swal.fire({
...
//*================== Start เลือกข้อมูลแบบประเมิน ป.01 ==================*//
        ...
        async savetablechkem() {    
            ...
            await axios.post('/evaluatebackend/api/savePushDataP01',{
                data: x,
...
//*================== Start เพิ่มข้อมูลแบบประเมิน ==================*//
        ...
        // บันทึกแบบจัดการ ป.1 
        async saveDatax() {
            await axios.post('/evaluatebackend/api/saveDataP01User',{
                staff_id: this.staffid_Main,
                fac_id: this.dataPor.fac_id,
                year_id: this.dataPor.d_date, 
                evalua: this.dataPor.evalua,
