                ...
                <div class="col md:col-5 text-right">   
                    <Dialog header="จัดการแบบ ป01" maximizable v-model:visible="DialogAdd" :breakpoints="{ '960px': '75vw' }" :style="{ width: '100vw' }" :modal="true" position="top">
                        ...
                        <TabView>
                                ...
                                <div class="grid">
                                    <div class="col-12 lg:col-12 xl:col-12">
                                        <div class="card mb-0">
                                            ...
                                            <div>
                                                <h5 class="mb-4">1) จุดเด่น และ/หรือ สิ่งที่ควรปรับปรุงแก้ไข</h5>
                                            </div>
                                            <div class="field">
                                                <textarea id="strengths-improvements" rows="4" class="custom-textarea" v-model="strengthsImprovements"></textarea>
                                            </div>
                                            <div>
                                                <h5 class="mb-4">2) ข้อเสนอแนะเกี่ยวกับวิธีส่งเสริมและพัฒนา</h5>
                                            </div>
                                            <div class="field">
                                    ...
                                    <div class="col-12 lg:col-12 xl:col-12">
                                        <div class="card mb-0">
                                            <div class="formgroup-inline mb-1">
                                                <div class="col md:col-12">
                                                    <h3 class="mb-4 card-header">
                                                        <i class="" style="font-size: x-large;"></i> ข้อตกลงและแบบการประเมินผลสัมฤทธิ์ของงานของข้าราชการและพนักงาน สังกัดมหาวิทยาลัยมหาสารคาม (องค์ประกอบที่ 1)
                                                    </h3>
                                                </div>
                                            </div>
                                            <!-- แสดงข้อมูลบันทึก -->
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th rowspan="2" style="width: 23%;">(1) <br> กิจกรรม / โครงการ / งาน</th>
                                                        ...
                                                        <th rowspan="2" style="width: 12%;">(4) <br> ค่าคะแนน ที่ได้</th>
                            ...
                            <TabPanel header="พฤติกรรมการปฏิบัติราชการ">
                                <div class="card">
                                    ...
                                    <div class="button-container">
                                        <Button label="บันทึกพฤติการปฏิบัติราชการ" icon="pi pi-save" class="mb-2 mr-2" @click="saveDataA" />
                                    </div>
                                </div>
                            </TabPanel>

                            <TabPanel header="รายงาน ป02">
                                <div class="card">
                            ...
                            <TabPanel header="แผนพัฒนาการปฏิบัติราชการรายบุคคล">
                                <div class="card">
                                    ...
                                    แบบรายงานผลการปฏิบัติราชการของข้าราชการและพนักงาน สังกัดมหาวิทยาลัยมหาสารคามตามข้อตกลงการประเมินผลสัมฤทธิ์ของงานและข้อตกลงการประเมินพฤติกรรมการปฏิบัติราชการ
                                    </h4><br>
                                    ...
                                    <tbody>
                                        <tr>
                                        <td><textarea id="textarea1" v-model="value1" rows="4" class="custom-textarea"></textarea></td>
                                        <td><textarea id="textarea2" v-model="value2" rows="4" class="custom-textarea"></textarea></td>
                                        <td><textarea id="textarea3" v-model="value3" rows="4" class="custom-textarea"></textarea></td>
                                        <td><Button icon="pi pi-save" label="บันทึก" severity="success" class="mb-2 mr-2" @click="saveDestop" /></td>
                                        </tr> 
                                        <tr>
                                        <td colspan="4" valign="top" style="background-color: #333333; color: #FFFFFF;">
                                        ...
                                        <td>testtest11</td>
                                        <td>testtest333</td>
                                        <td><Button icon="pi pi-delete-left" label="ลบ" severity="danger" class="mb-2 mr-2" /></td>
                                        </tr>
                                    </tbody>
                                    </table>
                                </div>
