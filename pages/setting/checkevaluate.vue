...
export default {
 ...
 /// New
    ...
    methods: { 
        ...
        async showDataEvalu(){
            await axios.get('/evaluatebackend/api/showDataEvalu',{
                // 28 / 11 / 67
                // params: {
                //     staff_id: this.staffid_Main,
                //     fac_id: this.facid_Main, 
        ...
        async Btnstatus(staff_id,status){   
            await axios.post('/evaluatebackend/api/postDataChkBtn',{ 
        ...
        tab2Data(staff_id){  
            axios.post('/evaluatebackend/api/showDataP03New',{
                staff_id: staff_id, 
        ...
        async showPostype(postypename,postypenameid){
           ...
           await axios.post('/evaluatebackend/api/showdatapostypename', {
